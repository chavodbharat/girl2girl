...
class FeedView extends React.Component {
    ...
    return (
      <SafeAreaView style={[GS.statusBar]}>
        <View style={[GS.flex1, GS.flexCol1]}>
          ...
          <View>
            {this.state.noConvos ? (
              <Text style={GS.textNoGroups}>{this.state.noGroupsText}</Text>
            ) : null}
          </View>
  ...
  _data = (offset = 0) => {
    ...
    Ajax.getFeed(
      ...
      err => {
        console.log('getting feed failed..',err);
        this.setState({async: false});
        this.setState(
          {
            ajaxMsg: err.message,
  ...
  follow = () => {
    ...
    Ajax.postFollowing(
      ...
      res => {
        ...
        this.setState(
          {
            ajaxMsg: `This convo ${Util.sanitize(
              this.state.convo.text,
            ).substring(0, 20)}... will now show up in your feed.`,
            alertType: 'Info',
            async: false,
    ...
    Ajax.deleteFollowing(
      ...
      res => {
        ...
        this.setState(
          {
            ajaxMsg: `This convo ${Util.sanitize(
              this.state.convo.text.substring(0, 20),
