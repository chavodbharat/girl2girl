        ...
        <ScrollView
          ...
          <View style={[GS.flexCol5]}>
            ...
            <ActionButton
              ...
              isDisabled={
                this.state.passwordInError || this.state.usernameInError
              }
              onPress={this.login}
              text="login"
            />
            <Text
              style={[GS.text, GS.colorWhite, GS.marginT15]}
              onPress={this.forgot}>
            ...
            <Text
              ...
              <Text style={[GS.bold]}> Create one here</Text>
            </Text>
            <ActionButton
