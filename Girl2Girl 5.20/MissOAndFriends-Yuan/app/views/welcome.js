...
import {Image, ScrollView, Text, View, Alert, SafeAreaView} from 'react-native';
      ...
      if (value) {
        ...
        Storage.getSIOAuth()
          ...
          .catch(err => {
            ...
            if (
              !Ajax.isUnderMaintenance(err) &&
              !Ajax.isTimeoutException(err)
            ) {
      ...
      <View
        ...
        <ScrollView
          ...
          <View style={[GS.flexCol5]}>
            ...
            />
            <Text style={[GS.colorWhite, GS.h1, {marginTop: 25}]}>
              Welcome!
            </Text>
            <ActionButton
              accessibility="login"
              ...
              text="login"
            />
            <Text style={[GS.text, GS.colorWhite, {marginTop: 25}]}>
