...
<module external.linked.project.id=":react-native-image-picker" external.linked.project.path="$MODULE_DIR$" external.root.project.path="$MODULE_DIR$/../../../android" external.system.id="GRADLE" version="4">
  ...
  <component name="NewModuleRootManager" LANGUAGE_LEVEL="JDK_1_7">
    ...
    <orderEntry type="library" scope="TEST" name="org.powermock:powermock-api-mockito:1.6.2@jar" level="project" />
    <orderEntry type="library" scope="TEST" name="org.apache.maven:maven-project:2.2.1@jar" level="project" />
    <orderEntry type="library" scope="TEST" name="org.objenesis:objenesis:2.1@jar" level="project" />
    ...
    <orderEntry type="library" scope="TEST" name="junit:junit:4.10@jar" level="project" />
    ...
    <orderEntry type="library" scope="TEST" name="org.easytesting:fest-assert-core:2.0M10@jar" level="project" />
    <orderEntry type="library" scope="TEST" name="org.powermock:powermock-classloading-xstream:1.6.2@jar" level="project" />
    ...
    <orderEntry type="library" scope="TEST" name="org.powermock:powermock-module-junit4-rule:1.6.2@jar" level="project" />
    <orderEntry type="library" scope="TEST" name="org.apache.maven:maven-model:2.2.1@jar" level="project" />
    <orderEntry type="library" scope="TEST" name="org.javassist:javassist:3.19.0-GA@jar" level="project" />
    <orderEntry type="library" scope="TEST" name="org.powermock:powermock-api-support:1.6.2@jar" level="project" />
    ...
    <orderEntry type="library" scope="TEST" name="org.easytesting:fest-util:1.2.5@jar" level="project" />
    ...
    <orderEntry type="library" scope="TEST" name="org.mockito:mockito-core:1.10.19@jar" level="project" />
    ...
    <orderEntry type="library" scope="TEST" name="org.apache.maven.wagon:wagon-provider-api:1.0-beta-6@jar" level="project" />
    <orderEntry type="library" scope="TEST" name="org.apache.maven:maven-artifact-manager:2.2.1@jar" level="project" />
    ...
    <orderEntry type="library" scope="TEST" name="org.powermock:powermock-reflect:1.6.2@jar" level="project" />
    <orderEntry type="library" scope="TEST" name="org.mockito:mockito-all:1.10.19@jar" level="project" />
    ...
    <orderEntry type="library" scope="TEST" name="org.powermock:powermock-core:1.6.2@jar" level="project" />
    ...
    <orderEntry type="library" scope="TEST" name="org.powermock:powermock-classloading-base:1.6.2@jar" level="project" />
